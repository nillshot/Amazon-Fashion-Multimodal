...
def main():
    ...
    print("\n=======================================================")
    print(" 🚀 V9 Training: Multi-Layer Cross-Attention + Hard Negative CCS")
    print("=======================================================")
    ...
    for epoch in range(PHASE_1_EPOCHS + 1, EPOCHS + 1):
        ...
        if val_mae < best_mae:
            best_mae = val_mae
            torch.save(model.state_dict(), "best_mobile_version_v9_model.pth")
            print(f"🌟 New Best Mobile Version V9 Model Saved (MAE: {best_mae:.4f})\n")
